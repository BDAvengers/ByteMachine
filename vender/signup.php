...
function sendemail_verify($full_name, $email, $verify_token)
{
    ...
    <h5>Подтвердите свою почту, нажав на ссылку 'Подтвердите почту'</h5>
    <br/><br/>
...
$phone_number_pattern2 = '/^\+77\d{9}$/';
    ...
    $statement = $connect->prepare("INSERT INTO clients (full_name, date_birth, email, phone_number, password, verify_token, status)
    VALUES (:full_name, :date_birth, :email, :phone_number, :password, :verify_token, 0)");
